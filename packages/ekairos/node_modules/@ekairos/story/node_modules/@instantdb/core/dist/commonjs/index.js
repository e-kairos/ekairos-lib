...
exports.InstantError = exports.version = exports.Storage = exports.Auth = exports.InstantCoreDatabase = exports.WindowNetworkListener = exports.IndexedDBStorage = exports.weakHash = exports.getOps = exports.i = exports.InstantAPIError = exports.TransactionValidationError = exports.validateTransactions = exports.QueryValidationError = exports.validateQuery = exports.lookup = exports.txInit = exports.tx = exports.id = exports.init_experimental = void 0;
exports.init = init;
...
function init(config, Storage, NetworkListener, versions) {
    ...
    const reactor = new Reactor_js_1.default(Object.assign(Object.assign(Object.assign({}, defaultConfig), config), { cardinalityInference: config.schema ? true : false }), Storage || IndexedDBStorage_ts_1.default, NetworkListener || WindowNetworkListener_js_1.default, Object.assign(Object.assign({}, (versions || {})), { '@instantdb/core': version_ts_1.default }));

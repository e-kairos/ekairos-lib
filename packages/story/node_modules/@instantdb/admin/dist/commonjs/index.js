...
exports.InstantAPIError = exports.i = exports.lookup = exports.tx = exports.id = exports.init_experimental = void 0;
exports.init = init;
...
function jsonFetch(input, init) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const headers = Object.assign(Object.assign({}, (init.headers || {})), { 'Instant-Admin-Version': version_ts_1.default, 'Instant-Core-Version': core_1.version });

...
export type ContextEvent = InstaQLEntity<typeof storyDomain, 'story_events'> & { content: any }
...
export class AgentService {
    ...
    public async getEvent(eventId: string): Promise<ContextEvent> {
        ...
        return event.story_events?.[0] as ContextEvent
    }
    ...
    public async getEvents(contextIdentifier: ContextIdentifier): Promise<ContextEvent[]> {
        ...
        return events.story_events as ContextEvent[]
    }

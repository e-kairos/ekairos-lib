...
console.log('  - DatasetService:', typeof dataset_1.DatasetService);
// Test 2: Story Domain
console.log('\n✓ Test 2: Story Domain from ekairos');
console.log('  - storyDomain:', typeof ekairos_1.storyDomain);
console.log('  - storyDomain.entities:', Object.keys(ekairos_1.storyDomain.entities || {}).join(', '));
console.log('  - Story entities:', ['story_contexts', 'story_events', 'story_executions'].every(e => e in (ekairos_1.storyDomain.entities || {})) ? 'All present ✓' : 'Missing some');
